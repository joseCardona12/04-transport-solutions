...
export default function SectionDashboard(): React.ReactNode {
  ...
  return (
    <section className="dashboard-section">
      <SectionTitle sectionTitle="Gestiòn de vehiculos" />
      <Filter />
      <ButtonsManage />
      <Table
      ...
      />
      <Pagination />
      {openModal.state && openModal.type === "MODAL_DELETE" && (
        <ModalDelete>
          <p className="body">
      ...
      {openModal.state && openModal.type === "MODAL_LOADING" && (
        <ModalLoading text="Saving filters for get vehicles..." />
      )}
      {openModal.state && openModal.type === "MODAL_CLEAN" && (
        <ModalLoading text="Deleting filters..." />
      )}
